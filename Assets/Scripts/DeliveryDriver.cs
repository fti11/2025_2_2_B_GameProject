...
public class DeliveryDriver : MonoBehaviour
{
    ...
    public class DriverEvents
    {
        ...
        public UnityEvent<int> OnDelivetyCountChanged;
    ...
    void Start()
    {
        ...
        driverEvents.OnDelivetyCountChanged?.Invoke(deliveryCount);
    }
    ...
    void HandleMovement()
    {
        ...
        if(moveDirection.magnitude > 0.1f)
        {
            ...
            ChangeBattery(-Time.deltaTime * 3.0f);     // 이동할 때마다 배터리 소모
        }
        else
        {
            if(isMoving)
