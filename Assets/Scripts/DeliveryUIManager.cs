...
public class DeliveryUIManager : MonoBehaviour
{
    ...
    void Start()
    {
        if(driver != null)
        {
            ...
            driver.driverEvents.OnDelivetyCountChanged.AddListener(UpdateDeliveryCount);
    ...
    void OnDestroy()        // 객체가 파괴될 때 시점
    {
        if(driver != null)
        {
            ...
            driver.driverEvents.OnDelivetyCountChanged.RemoveListener(UpdateDeliveryCount);
